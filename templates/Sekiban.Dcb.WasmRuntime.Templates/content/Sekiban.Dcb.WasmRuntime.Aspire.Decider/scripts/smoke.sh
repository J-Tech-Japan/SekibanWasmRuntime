...
SAMPLE_DIR="."
APPHOST="SekibanDcbDecider.AppHost/SekibanDcbDecider.AppHost.csproj"
ARTIFACT_DIR="$ROOT"
MODULE="$ARTIFACT_DIR/modules/SekibanDcbDecider.wasm"
MANIFEST="$ARTIFACT_DIR/config/sekiban-manifest.json"
REPORT_DIR="$ROOT/reports/smoke"
REPORT="$REPORT_DIR/SekibanDcbDecider-smoke.md"
...
IMAGE_TAG_USED="${SAMPLE_RUNTIME_IMAGE_TAG:-1.0.0-preview.7}"

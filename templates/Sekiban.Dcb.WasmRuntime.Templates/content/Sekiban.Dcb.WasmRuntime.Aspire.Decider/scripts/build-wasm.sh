...
#
# Outputs (git-ignored):
#   modules/SekibanDcbDecider.wasm
...
WASM_PROJ_REL="SekibanDcbDecider.Wasm/SekibanDcbDecider.Wasm.csproj"
NUGET_WASM_CONFIG_REL="NuGet.wasm.config"
ARTIFACT_DIR="."
PUBLISH_DIR_REL="publish"
MODULES_DIR="$ROOT/modules"
CONFIG_DIR="$ROOT/config"
MODULE_NAME="SekibanDcbDecider.wasm"
...
echo "[build-wasm] manifest: config/sekiban-manifest.json"
echo "[build-wasm] OK"

...
| npm `@sekiban/dcb-client` | 0.2.0 | npm (published) | `1.0.0-preview.3` | Published | SWR-G089 registry-backed consumers; SDT-G71 empty-state gate in 0.2.0; extraction smoke (SWR-G057), `npm-ts-preview-readiness.md` |

...
- [ ] Confirm required approval for the public ELv2 boundary wording has no
  unresolved drift before package publication. Approval evidence is retained
...
- [ ] Missing required approval for the public ELv2 boundary wording is treated
  as release-blocking. Do not publish host-only signoff evidence in this
  repository.
